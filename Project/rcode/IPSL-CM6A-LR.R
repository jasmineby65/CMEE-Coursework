...
data <- as.data.frame(read.csv("../csv/IPSL-CM6A-LR_epc100_whole.csv", header = TRUE, stringsAsFactors = F))
head(data)
...
### Result summary 
sink("../output/IPSL-CM6A-LR/epc100_whole.txt")

cat("epc100 IPSL-CM6A-LR\nWhole region result:\n\n\n")
