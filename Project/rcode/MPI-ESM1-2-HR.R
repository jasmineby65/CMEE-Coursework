...
data <- as.data.frame(read.csv("../csv/MPI-ESM1-2-HR_epc100_whole.csv", header = TRUE, stringsAsFactors = F))
head(data)
...
### Result summary 
sink("../output/MPI-ESM1-2-HR/epc100_whole.txt")

cat("epc100 MPI-ESM1-2-HR\nWhole region result:\n\n\n")
