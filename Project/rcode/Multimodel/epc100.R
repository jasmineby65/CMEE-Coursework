...
data <- as.data.frame(read.csv("../csv/Multimodel_epc100_whole.csv", header = TRUE, stringsAsFactors = F))
head(data)
...
### Result summary 
sink("../output/Multimodel/epc100_whole.txt")

cat("epc100 Multimodel\nWhole region result:\n\n\n")
...
data <- as.data.frame(read.csv("../csv/Multimodel_epc100_inc.csv", header = TRUE, stringsAsFactors = F))
head(data)
...
### Result summary 
sink("../output/Multimodel/epc100_inc.txt")
...
data <- as.data.frame(read.csv("../csv/Multimodel_epc100_dec.csv", header = TRUE, stringsAsFactors = F))
head(data)
...
### Result summary 
sink("../output/Multimodel/epc100_dec.txt")
