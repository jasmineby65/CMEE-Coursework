...
data <- as.data.frame(read.csv("../csv/CMCC-ESM2_epc100_inc.csv", header = TRUE, stringsAsFactors = F))
head(data)
...
### Result summary 
sink("../output/CMCC-ESM2/epc100_inc.txt")
...
data <- as.data.frame(read.csv("../csv/CMCC-ESM2_epc100_dec.csv", header = TRUE, stringsAsFactors = F))
head(data)
...
### Result summary 
sink("../output/CMCC-ESM2/epc100_dec.txt")
